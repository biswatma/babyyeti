...
/* ================= WIFI ================= */
const char* WIFI_SSID = "ssidname"; /*add your ssid name 2.5ghz only*/
...
void drawAnalogClock() {
  ...
  display.setCursor(cx-4, cy-r+2); display.print("12");
  display.setCursor(cx+r-10, cy-3); display.print("3");
  display.setCursor(cx-3, cy+r-10); display.print("6");
  display.setCursor(cx-r+4, cy-3); display.print("9");
